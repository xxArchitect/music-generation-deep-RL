...
class PrioritizedExperienceBuffer:
    ...
    def push(self, *args):
        """Save an experience to the buffer with maximum priority."""
...
class RLTunerPER(RLTuner):
    ...
    def build_graph(self):
        """Builds the reinforcement learning graph with prioritized experience replay."""
    ...
    def training_step(self):
        """Modified training step to incorporate PER."""
